...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 3884.735679581603; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 2151.809822089486; // x position of the perpendicular encoder (in tick units)
    }
