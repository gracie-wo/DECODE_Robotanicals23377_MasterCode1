...
@TeleOp(name = "Blue PGP", group = "Blue Main")
public class BLUE_PGP_main extends LinearOpMode {final double kP = 12;
...
//        launcher.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        ...
        BLUE_PGP_main.SimplePIDController pidController = new BLUE_PGP_main.SimplePIDController();
