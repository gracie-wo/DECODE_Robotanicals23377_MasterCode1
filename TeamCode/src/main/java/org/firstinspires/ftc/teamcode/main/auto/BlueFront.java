...
//        PIDFCoefficients pidfOrigR = motorControllerExR.getPIDFCoefficients(motorIndexR, DcMotor.RunMode.RUN_USING_ENCODER);
        ...
        public class LaunchOn implements Action{
            @Override
            public boolean run(@NonNull TelemetryPacket packet) {
                double launchPower = (0.0025 * getDistanceFromTags(llResult.getTa())) + voltSpeed();
    ...
    public class Rotator {
        ...
        public class RotateMiddle implements Action {
            @Override
            public boolean run(@NonNull TelemetryPacket packet){
        ...
        public Action rotateMiddle(){
            return new RotateMiddle();
        }
    ...
    public void runOpMode() {
        ...
        //make sure to switch pipeline later
        ...
        Actions.runBlocking(kickerRotate.kickerRotateDown());
        Actions.runBlocking(rotator.rotateMiddle());
