    ...
    @Config
    @Disabled
    @Autonomous(name = "AutoRedBackShoot", group = "Autonomous")
    public class RedBackShoot extends LinearOpMode {
        ...
        public void runOpMode() {
            ...
            Pose2d launchPose = new Pose2d(23, 74, Math.toRadians(45));
            ...
            // ------------------------- AUTO TRAJECTORY -------------------------
            Action shoot = drive.actionBuilder(initialPose)
                    ...
                    .build();
            sleep(400);
            Action line1 = drive.actionBuilder(launchPose)

                    // Move forward from start
                    .strafeToConstantHeading(new Vector2d(17, 0))
                    ...
                    // Start intake before reaching ball row
                    .afterDisp(5,
                            new ParallelAction(
                                    intake.intakeOn(),
                                    sweeper1R.sweeper1RIntakeOn(),
                    ...
                    // Sweep full row
                    .strafeToConstantHeading(new Vector2d(41, 0))
            ...
            Action line2 = drive.actionBuilder(launchPose)

                    .turn(Math.toRadians(-135))

                    .strafeToConstantHeading(new Vector2d(54, 74))
                    .strafeToConstantHeading(new Vector2d(54, 25))
                    ...
                    .strafeToLinearHeading(new Vector2d(23, 74), Math.toRadians(135))
            ...
            Action line3 = drive.actionBuilder(launchPose)

                    .strafeToLinearHeading(new Vector2d(25, 68), Math.toRadians(-135))
                    ...
                    .strafeToConstantHeading(new Vector2d(68, 68))
                    ...
                    .strafeToConstantHeading(new Vector2d(68, 74))
            ...
            sleep(400);
            Actions.runBlocking(line1);
            sleep(400);
            Actions.runBlocking(line2);
            sleep(400);
            Actions.runBlocking(line3);
            sleep(400);
        }
    }
